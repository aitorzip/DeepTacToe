...
// CXXSSLLibTestHarness - Proprietary and confidential
...
class CXXSSLLibTestHarness : public CxxTest::TestSuite
{
    public:
        CXXSSLLibTestHarness(void)
        {
        }

        ~CXXSSLLibTestHarness(void) override
        {
        }
